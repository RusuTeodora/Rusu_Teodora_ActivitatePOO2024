...
public:
	...
	friend ostream& operator<<(ostream& output, Oras o) {
		output << "Orasul are" << " ";
		output << o.nrLocuitori;
		output << " "<<"locuitori" << endl;
		return output;
	}

	void afisare() {
		cout << "Orasul are " << " " << this->nrLocuitori << " " << "locuitori" << endl;
	}
};
